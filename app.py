...
# all the resources
api.add_resource(AllItems, '/allitems')        
api.add_resource(Items, '/categories/<category_id>/items')
api.add_resource(Item, '/categories/<category_id>/items','/store/<category_id>/items/<id>')
api.add_resource(Category, '/categories','/categories/<id>')
api.add_resource(CategoryList, '/allcategories')
